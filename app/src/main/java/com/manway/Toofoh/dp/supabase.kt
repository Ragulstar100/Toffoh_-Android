...
//Andriod Only
@Composable
fun SupabaseClient.getImage(url: ImageUrl?, modifier: Modifier = Modifier, contentScale: ContentScale){
    url?.let {
...
enum class Table{
    ...
    OwnerInfo,RestaurantInfo,FoodInfo,OrderInfo,CommonFoodInfo
}
